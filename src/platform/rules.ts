...
function generateInstructions(config: WhygraphConfig): string {
  ...
  return [
    ...
    "",
    "**For context:** Read `.whygraph/graph/*.md` directly. Find entities whose",
    "`affects` field references the file or node you are working in. The",
    "`label` field identifies type: `App`, `Feature`, `Component`, `Decision`.",
    "",
